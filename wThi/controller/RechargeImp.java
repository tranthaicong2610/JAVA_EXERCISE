...
public class RechargeImp implements Recharge {
    @Override
    synchronized public void rechargeMoney(ArrayList<Account> accounts, ArrayList<AccountHistory> accountHistories, int id, double increaseMoney,String description) {
