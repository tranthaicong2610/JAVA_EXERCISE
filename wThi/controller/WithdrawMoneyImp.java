...
public class WithdrawMoneyImp implements WithdrawMoney {
    ...
    @Override
    synchronized public void withdrawMoney(ArrayList<Account> accounts, ArrayList<AccountHistory> accountHistories, int id, double withdrawAmount,String description) {
